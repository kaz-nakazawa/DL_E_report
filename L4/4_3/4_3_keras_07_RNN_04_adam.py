...
print('RNN 4 出力ノード数:128 出力活性化関数:sigmoid 最適化:adam Test loss:', round (100 * score[0],2),'%')
print('RNN 4 出力ノード数:128 出力活性化関数:sigmoid 最適化:adam Test accuracy:',round (100 * score[1],2),'%')
