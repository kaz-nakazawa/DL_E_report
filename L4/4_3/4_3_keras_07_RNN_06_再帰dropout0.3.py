...
print('RNN 6 出力ノード数:128 出力活性化関数:sigmoid 最適化:adam 入力 Dropout:0.5 再帰Dropout:0.3 Test loss:',round (100 * score[0],2),'%')
print('RNN 6 出力ノード数:128 出力活性化関数:sigmoid 最適化:adam 入力 Dropout:0.5 再帰Dropout:0.3 Test accuracy:', round (100 * score[1],2),'%')
