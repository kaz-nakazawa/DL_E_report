...
weight_decay_lambda = 0.003 # [try] weigth_decay_lambdaの値を変更して正則化の強さを確認しよう
# =================================================
...
for i in range (iters_num):
    ...
    for idx in range (1, hidden_layer_num + 1):
        ...
        weight_decay += weight_decay_lambda * np.sum (np.abs (network.params ['W' + str (idx)]))  # L1
