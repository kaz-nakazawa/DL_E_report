...
print('RNN 3 出力ノード数:128 出力活性化関数:tanh Test loss:', round (100 * score[0],2),'%')
print('RNN 3 出力ノード数:128 出力活性化関数:tanh Test accuracy:', round (100 * score[1],2),'%')
